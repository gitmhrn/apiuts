...
$app->register(Illuminate\Hashing\HashServiceProvider::class); // Untuk hash password kalau belum
$app->register(Illuminate\Validation\ValidationServiceProvider::class); // Untuk Validator
